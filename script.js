...
function draw() {
  ...
  if (
    obstacleX > basketX &&
    obstacleX < basketX + 130 &&
    obstacleY > basketY &&
    obstacleY < basketY + 230
  ) {
    score--;
  ...
  if (
    obstacle2X > basketX &&
    obstacle2X < basketX + 130 &&
    obstacle2Y > basketY &&
    obstacle2Y < basketY + 230
  ) {
    score -= 2;
  ...
  function resetGame() {
    score = 0;
    fruitX = Math.random() * (canvas.width - 50);
    fruitY = 0;
    fruit2X = Math.random() * (canvas.width - 50);
    fruit2Y = 0;
    fruit3X = Math.random() * (canvas.width - 50);
    fruit3Y = 0;
    obstacleX = Math.random() * (canvas.width - 50);
    obstacleY = 0;
    obstacle2X = Math.random() * (canvas.width - 50);
    obstacle2Y = 0;
